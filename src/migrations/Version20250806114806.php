 ...
 */
final class Version20250806114806 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE order_item (id SERIAL NOT NULL, product_id INT NOT NULL, order_id INT NOT NULL, count INT NOT NULL, PRIMARY KEY(id))');
